...
[![Build Status](https://api.cirrus-ci.com/github/davejames/system.svg?branch=master)](https://cirrus-ci.com/github/davejames/system)
...
```bash
sudo nixos-install --flake github:davejames/system#phil
```
...
```bash
git clone https://github.com/davejames/system ~/.nixpkgs
```
